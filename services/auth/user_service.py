...
class UserService:
    ...
    async def create_user(self, user_data: UserCreateByEmailModel, session: AsyncSession) -> User:
    ...
    async def create_user(self, user_data: UserCreateByOauthModel, session: AsyncSession) -> User:
        user_data_dict = user_data.model_dump()
